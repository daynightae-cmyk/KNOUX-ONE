...
const expectedHandlers = {
  'm04.storage.scan': ['m04_storage_scan_complete', 'completion14::m04'],
  ...
  'm04.files.old': ['m04_old_files_complete', 'completion14::m04'],
  'm04.downloads.analyze': ['m04_downloads_complete', 'completion14::m04'],
  'm04.appdata.analyze': ['m04_appdata_complete', 'completion14::m04'],
  'm04.drives.external': ['m04_external_drives_complete', 'completion14::m04'],
  'm04.space.check': ['m04_space_check_complete', 'completion14::m04'],
  'm04.report.export': ['m04_report_export_complete', 'completion14::m04'],
  'm04.scan.cancel': ['m04_scan_cancel_complete', 'completion14::m04'],
} as const;
