...
const expectedHandlers = {
  'm02.cleanup.scan': ['m02_cleanup_scan_complete', 'completion14::m02'],
  'm02.cleanup.execute': ['m02_cleanup_execute_complete', 'completion14::m02'],
  'm02.cleanup.cancel': ['m02_cleanup_cancel_complete', 'completion14::m02'],
  'm02.cleanup.history': ['m02_cleanup_history_complete', 'completion14::m02'],
  'm02.scan.user_temp': ['m02_scan_user_temp', 'cleanup::commands'],
  'm02.scan.windows_temp': ['m02_scan_windows_temp_complete', 'completion14::m02'],
  ...
  'm02.scan.crash_dumps': ['m02_scan_crash_dumps_complete', 'completion14::m02'],
  'm02.scan.application_logs': ['m02_scan_application_logs_complete', 'completion14::m02'],
  'm02.scan.old_downloads': ['m02_scan_old_downloads_complete', 'completion14::m02'],
} as const;
